...
class DinoRun extends FlameGame with TapDetector, HasCollisionDetection {
  ...
  Future<void> onLoad() async {
    ...
    final parallaxBackground = await loadParallaxComponent(
      [
        ParallaxImageData('parallax/new/0.png'),
        ParallaxImageData('parallax/new/1.png'),
        ParallaxImageData('parallax/new/2.png'),
        ParallaxImageData('parallax/new/3.png'),
        ParallaxImageData('parallax/new/4.png'),
        ParallaxImageData('parallax/new/5.png'),
        ParallaxImageData('parallax/new/6.png'),
  ...
  void startGamePlay() {
    _dino = Dino(images.fromCache('Sprite.png'), playerData);
